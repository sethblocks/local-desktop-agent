...
prompt = ChatPromptTemplate.from_messages([
    ("system", "You are a reasoning agent with tools. Answer the question or complete the task using reasoning and tools given to you. You will need to problem solve some tasks when errors occur."),
    ("human", "{input}"),
